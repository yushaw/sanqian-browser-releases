...
# 为 large 和 marquee 添加内嵌 SVG 和下载按钮

SVG_CODE='<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 415.87 428.2">
...
echo "正在更新 promo-large-920x680.html..."

# 为 large promo 创建新版本
cat > promo-large-920x680.html.new << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Sanqian Browser - Large Promo (920x680)</title>
...
# 插入 SVG
echo "$SVG_CODE" >> promo-large-920x680.html.new

# 继续HTML
cat >> promo-large-920x680.html.new << 'EOF'
            </div>
            <div class="title">Sanqian Browser</div>
        ...
        <div class="instructions">
            <h2>🚀 一键下载:</h2>
            <button class="download-btn" onclick="downloadPromo()">
                📥 下载大宣传图 (920×680)
            </button>
            <p style="margin-top: 10px; color: #999; font-size: 12px; text-align: center;">
                💡 点击按钮自动生成高清图片
            </p>
        </div>
    </div>
        ...
        function downloadPromo() {
            ...
            html2canvas(container, {
                ...
                canvas.toBlob(blob => {
                    ...
                    a.href = url;
                    a.download = 'sanqian-browser-promo-920x680.png';
                    ...
                    setTimeout(() => {
                        button.textContent = '📥 下载大宣传图 (920×680)';
                    }, 2000);
                }, 'image/png');
            }).catch(err => {
                console.error('生成失败:', err);
                button.textContent = '❌ 生成失败,请刷新重试';
                button.disabled = false;
            });
        }
    </script>
...
mv promo-large-920x680.html.new promo-large-920x680.html

echo "✅ large promo 更新完成!"
echo "✅ 所有宣传图HTML已更新完成!"
